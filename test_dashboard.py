...
def test_build_reply_prefill_html_quotes_original_message():
    ...
    html = dashboard.build_reply_prefill_html(details)

    assert "On 2026-01-01 12:00:00 UTC, alice wrote:" in html
